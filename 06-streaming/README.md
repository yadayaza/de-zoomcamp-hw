...
```bash
redpanda@1af454294605:/$ rpk version
v22.3.5 (rev 28b2443)
```
...
```bash
redpanda@1af454294605:/$ rpk topic create test-topic
TOPIC       STATUS
test-topic  OK
```
...
took 82.25 seconds
```
With those computer specs:
```
OS: Ubuntu 20.04.6 LTS x86_64 
Host: 20A70037US ThinkPad X1 Carbon 2nd 
Kernel: 5.4.0-174-generic 
Shell: bash 5.0.17 
CPU: Intel i7-4600U (4) @ 2.000GHz 
GPU: Intel Haswell-ULT 
Memory: 5821MiB / 7610MiB 
```
`82`
