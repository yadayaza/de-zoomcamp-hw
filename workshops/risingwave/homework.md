...
FROM 
    trip_data 
    JOIN taxi_zone t 
        ON pulocationid = t.location_id
    JOIN taxi_zone t2 
        ON dolocationid = t2.location_id
GROUP BY t.zone, t2.zone;
...
LIMIT 1;
 ...
 min_trip_time | max_trip_time | avg_trip_time |  pickup_zone   | dropoff_zone 
---------------+---------------+---------------+----------------+--------------
 23:59:33      | 23:59:33      | 23:59:33      | Yorkville East | Steinway
(1 row)
...
LIMIT 1;
 ...
 min_trip_time | max_trip_time | avg_trip_time |  pickup_zone   | dropoff_zone | count_trips 
---------------+---------------+---------------+----------------+--------------+-------------
 23:59:33      | 23:59:33      | 23:59:33      | Yorkville East | Steinway     |           1
(1 row)
